...
import com.example.jwork_android.request.ApplyJobRequest;
import com.example.jwork_android.request.BonusRequest;
...
public class ApplyJobActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnHitung = findViewById(R.id.btnCount);
