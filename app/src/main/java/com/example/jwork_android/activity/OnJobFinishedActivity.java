...
import com.example.jwork_android.request.CancelJobRequest;
import com.example.jwork_android.request.FetchJobRequest;
import com.example.jwork_android.request.FinishJobRequest;

import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;

public class OnJobFinishedActivity extends AppCompatActivity {
    ...
    private void fetchJob(){
        final Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.isEmpty()) {
                    Toast.makeText(OnJobFinishedActivity.this, "No job applied!", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(OnJobFinishedActivity.this, MainActivity.class);
        ...
        FetchJobRequest fetchRequest = new FetchJobRequest(String.valueOf(jobseekerId), responseListener);
        RequestQueue queue = Volley.newRequestQueue(OnJobFinishedActivity.this);
    ...
    private void initButtons(){
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(OnJobFinishedActivity.this, "Your job has been canceled!", Toast.LENGTH_LONG).show();
                CancelJobRequest batalRequest = new CancelJobRequest(String.valueOf(invoiceId), cancelListener);
                RequestQueue queue = Volley.newRequestQueue(OnJobFinishedActivity.this);
        ...
        btnFinish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(OnJobFinishedActivity.this, "Your job is finished!", Toast.LENGTH_LONG).show();
                FinishJobRequest selesaiRequest = new FinishJobRequest(String.valueOf(invoiceId), doneListener);
                RequestQueue queue = Volley.newRequestQueue(OnJobFinishedActivity.this);
